            ...
            <View style={styles.containerWrapper}>
                ...
                <View style={[styles.container, {flexBasis: '80%'}, {padding: '10px'}]}>
                    <View
                        ...
                        onClick={!this.state.voted1 && !this.state.voted2 ? () => this.voteUser(this.state.idUser1) : () => ''}>
                    ...
                    <View
                        ...
                        onClick={!this.state.voted1 && !this.state.voted2 ? () => this.voteUser(this.state.idUser2) : () => ''}>
